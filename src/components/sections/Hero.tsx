          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-600 leading-relaxed max-w-2xl">
                Astrounaut provides innovative solutions and exceptional service to help your business reach new heights. We're here to guide you through every step of your journey.
              </p>
            </div>
          ...
          >
            <div className="aspect-square bg-gradient-to-br from-primary-400 to-primary-600 rounded-3xl shadow-2xl flex items-center justify-center">
              <div className="text-white text-center space-y-4">
                ...
                <p className="text-primary-100">Launching Your Success</p>
              </div>
            </div>
